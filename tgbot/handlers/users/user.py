    ...
    try:
        ...
        if sub.status != "left":
            ...
            await bot.send_message(chat_id=user_id, text='<b>Привет 👋</b>\n\n'
                                                         ...
                                                         '<b><a href="https://t.me/+MdKJNt3W6K01YmJi">Подписаться</a></b>\n\n'
...
🇦🇹 Австрия, Вена - <code>au.q-access.store</code>
...
Поддерживаются все современные устройства, на которые есть приложения для подключения к VPN. Найти список доступных приложений можно в главном меню""",
